  ...
  function chart(element, options) {
    ...
    set(config, 'data.datasets',
      $.map(options.values, function(value) {
        if (value.colorStop1 && value.colorStop2) {
          var y0 = value.y0, y1 = value.y1;
          var gradient = ctx.createLinearGradient(0, y0, 0, y1);

          gradient.addColorStop(0, value.colorStop1);
          gradient.addColorStop(1, value.colorStop2);
          value.backgroundColor = gradient;
          value.hoverBackgroundColor = gradient;

          delete value.colorStop1;
          delete value.colorStop2;
          delete value.y0;
          delete value.y1;
        }
